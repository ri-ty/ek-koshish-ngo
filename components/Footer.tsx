...
const socialLinks = [
  {
    label: "Facebook",
    href: "https://www.facebook.com/people/Ek-Koshish-Esi-Bhi/100064104032819/",
    icon: (
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/tv/CSmNw9-BCat/?igsh=MWE1cGttZzhtbXNoOA==",
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "YouTube",
    href:"https://youtube.com/@neelamsharmapresidentekkos7217?si=42lILIAqQPf9AhgD",
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid gap-10 md:grid-cols-3">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-ivory/70">
              <li>
                <a href="tel:+917827939146" className="hover:text-gold">
                  +91 7827939146
                </a>
              </li>
              <li>
            ...
            <div className="mt-6 flex gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-md bg-ivory/10 text-ivory transition-colors hover:bg-primary hover:text-white"
                >
                  {social.icon}
                </a>
              ))}
