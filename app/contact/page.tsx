    ...
    <>
      ...
      <section className="py-20">
        <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
          <FadeIn>
            <div className="rounded-md border border-foreground/10 bg-surface p-8 shadow-sm sm:p-10">
              ...
              <div className="mt-8 space-y-6">
                ...
                <div className="flex items-start gap-4">
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-md bg-[#25D366]/10 text-[#25D366]">
